    ...
    <body>
        ...
        <form method="post" action="NouvelUtilisateur">
            <fieldset>
                ...
                <input type="email" id="email" name="email" value="<c:out value="${utilisateur.emailUtilisateur}"/>" size="20" maxlength="60" />
                <span class="erreur" id="emailJQuery">${form.erreurs['email']}</span>
                <br />

                <label for="password">Mot de passe <span class="requis">*</span></label>
                <input type="password" id="password" name="password" value="" size="20" maxlength="20" />
                <span class="erreur" id="passwordJQuery">${form.erreurs['password']}</span>
                <br />
                ...
                <input type="text" id="nom" name="nom" value="<c:out value="${utilisateur.nomUtilisateur}"/>" size="20" maxlength="20" />
